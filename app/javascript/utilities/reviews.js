document.addEventListener('turbolinks:load', function() {
	...
	if (controllerPart == 'recipes' && actionPart == 'show' || controllerPart == 'reviews' && actionPart == 'new') {
		// Получаем ссылки на дочерние DOM элементыЖ class = "ratings" 
		// const starsParents = document.querySelector(".ratings").children;
		const starsParents = document.querySelector(".ratings");
		
		if (starsParents) {
			const stars = starsParents.children;
