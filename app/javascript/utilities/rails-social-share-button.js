    ...
    share: function(el) {
      ...
      switch (site) {
        ...
        case "douban":
          ...
          break;
        case "facebook":
          RailsSocialShareButton.openUrl("https://www.facebook.com/sharer/sharer.php?u=" + url + "&amp;src=sdkpreparse", 555, 400);
          break;
          // RailsSocialShareButton.openUrl("http://www.facebook.com/sharer/sharer.php?href=" + url + "&display=popup&quote=" + desc, 555, 400);
          // RailsSocialShareButton.openUrl("https://www.facebook.com/sharer/sharer.php?u=" + url + "&display=popup&quote=" + desc, 555, 400);
        case "qq":
